...
exports.clear_all_devices = function(params,cb) {

    this.opts.devices = null;
    this.save();
     this._app.log.info('Clear All Devices');
...
exports.remove_show_menu = function(params,cb) {
  ...
  var listJSON = helpers.generateListObject(this._app, this.opts.devices);
